...
export class AddMintMetricsTable1783982762826 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "metrics_mint" ("id" varchar PRIMARY KEY NOT NULL, "metric" text NOT NULL, "labels" text NOT NULL, "type" text NOT NULL, "date" integer NOT NULL, "value" real, "sum" real, "count" integer, "buckets" text, "updated_at" integer NOT NULL)`,
		);

...
@Component({
	selector: 'orc-index-subsection-system-control',
	standalone: false,
	templateUrl: './index-subsection-system-control.component.html',
	styleUrl: './index-subsection-system-control.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IndexSubsectionSystemControlComponent {
